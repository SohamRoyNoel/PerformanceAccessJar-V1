...
public class ValueParser {
	...
	public static void ResourceAnalyser(WebDriver driver, int appId, int pageId, int testCaseId) throws InterruptedException{
	...
	// Navigation Status
	@SuppressWarnings("unused")
	public static void NavigationAnalyser(WebDriver driver, int appId, int pageId, int testCaseId) throws InterruptedException{
